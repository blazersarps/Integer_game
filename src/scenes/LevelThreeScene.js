...
import { level_three_questions } from "../questions";
...
const questions = level_three_questions;
var score = 0;
var tries = 1;
var question = 1;
var questionsRecord = [];
...
export default class LevelThreeScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio("question3", ["assets/audio/question3.mp3"]);
  ...
  create() {
    ...
    var question3 = this.sound.add("question3");
            ...
            if (tries === 3) {
              personData.gameOvers = personData?.gameOvers
                ? [
                    ...
                    { no: question, tries, time: new Date(), Level: 3 },
                  ]
                : [{ no: question, tries, time: new Date(), Level: 3 }];
              localforage
              ...
              Swal.fire({
                position: "top",
                text: "The numbers to the right side of the number line gets bigger and bigger",
                width: 300,
              });
            }
          }
    ...
    this.physics.add.overlap(player, platformEnd, () => {
      if (score >= 600) {
        ...
        personData.levelThreeData = {
          score,
          totalTimeSpent,
          questionsRecord,
        };
        personData.levelThreeComplete = true;
        localforage
          .setItem(this.playerName, personData)
          .then(function () {
